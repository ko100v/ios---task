...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // Create instance of UINavigationController to hold ( First Visible UIViewController )
        let navigationController = BaseNavController()
        navigationController.navigationBar.barStyle = .Black

        // Create instance of UIViewController ( First Visible UIViewController )
        let notificationViewController = NotificationViewController()
        
        // Make notificationViewController RootViewController of navigationController
